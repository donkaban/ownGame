...
def demo_pygame(file_name):
    ...
    world_map = game.tmx.tmxreader.TileMapParser().parse_decode(file_name)
    ...
    resources = game.tmx.helperspygame.ResourceLoaderPygame()
    ...
    # renderer
    renderer = game.tmx.helperspygame.RendererPygame()
    ...
    # retrieve the layers
    sprite_layers = game.tmx.helperspygame.get_layers_from_map(resources)
...
def create_hero(start_pos_x, start_pos_y):
    ...
    return game.tmx.helperspygame.SpriteLayer.Sprite(image, rect)
